<template>
  ...
  <div class="body">
    ...
    <section>
      <LastChart :minimize="consultingGivenChart" :clientIP="componentsClientIP" :key="lastChartKey" />
      <LastChart v-if="consultingGivenChart" /> <!-- TODO -->
    </section>
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.id) {
      setTimeout(() => {
        this.consultingGivenChart = true
      }, 1300)
    }
  },
  watch: {
